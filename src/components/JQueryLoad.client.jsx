        ...
        return {
          ...
          mobileMenu() {
            $('.js-mobile-menu-dropdown-btn').on('click', function () {
              $(this)
                .parent()
                .find('.js-mobile-menu-dropdown-menu')
                .slideToggle(500);
            });
          ...
          homeFullWidthSlider() {
            ...
            $('.js-slider-item-thumbnail').on('click', function () {
              ...
              $(".js-slider-item[data-id='" + sliderId + "']")
                .find('.js-slider-item-thumbnail')
                .removeClass('active');
              $(this).addClass('active');
              $(".js-slider-item[data-id='" + sliderId + "']")
                .find('.js-slider-item-image')
                .removeClass('active');
              $(".js-slider-item[data-id='" + sliderId + "']")
                .find(".js-slider-item-image[data-id='" + id + "']")
                .addClass('active');
              return false;
            });
          },
          ...
          homeMinimalSlider() {
            ...
            if ($('.js-home-minimal-slider').length > 0) {
              $('.minimal-slider .slick-prev').css(
                'left',
                $('.minimal-slider__feature').offset().left,
              );
              $('.minimal-slider .slick-next, .minimal-slider .slick-dots').css(
                'right',
                $('.minimal-slider__feature').offset().left,
              );
              $(window).resize(function () {
                setTimeout(function () {
                  ...
                  $(
                    '.minimal-slider .slick-next, .minimal-slider .slick-dots',
                  ).css('right', $('.minimal-slider__feature').offset().left);
                }, 200);
              });
            }
          },

          homeMinimalInstagram() {
          ...
          // Product grid item
          productGridItemImages() {
            $('.js-product-grid-previous-image').on('click', function () {
              var currentImage = parseInt(
                $(this)
                  .parent()
                  .parent()
                  .parent()
                  .find('.js-product-grid-images')
                  .attr('data-current-image'),
              );
              ...
              var totalImages =
                parseInt(
                  $(this)
                    ...
                    .parent()
                    .parent()
                    .find('.js-product-grid-image').length,
                ) - 1;
              $(this)
                .parent()
                .parent()
                .parent()
                .find('.js-product-grid-image')
                .removeClass('active');
              if (previousImage >= 0) {
                $(this)
                  .parent()
                ...
                $(this)
                  ...
                  .parent()
                  .find('.js-product-grid-images')
                  .attr('data-current-image', previousImage);
              } else {
                $(this)
                  .parent()
                  .parent()
                ...
                $(this)
                  ...
                  .parent()
                  .find('.js-product-grid-images')
                  .attr('data-current-image', totalImages);
              }
            });
            $('.js-product-grid-next-image').on('click', function () {
              ...
              if (
                ...
                $(this)
                  ...
                  .parent()
                  .find('.js-product-grid-images')
                  .attr('data-current-image', nextImage);
              } else {
                $(this)
                  .parent()
                  .parent()
              ...
              var totalImages =
                parseInt(
                  $(this)
                    ...
                    .parent()
                    .parent()
                    .find('.js-product-list-image').length,
                ) - 1;
              $(this)
                .parent()
                .parent()
                .parent()
                .find('.js-product-list-image')
                .removeClass('active');
              if (previousImage >= 0) {
                $(this)
                  .parent()
          ...
          collectionFilter() {
            ...
            if ($('.js-price-slider').length) {
              ...
              if ($('.js-price-slider-value').length) {
                $('.js-price-slider-value').val(
                  '$' +
                    $('.js-price-slider').slider('values', 0) +
                    ' - $' +
                    $('.js-price-slider').slider('values', 1),
                );
              }
            }
          },
          ...
          productImages() {
            $('.js-product-thumbnail').on('click', function () {
              ...
              $(".js-product-main-image[data-id='" + id + "']").addClass(
                'active',
              );
              durotan.zoom();
              if ($('.js-product-layout-2').length > 0) {
                $('html, body')
                  ...
                  .animate(
                    {
                      scrollTop: $(
                        ".js-product-main-image[data-id='" + id + "']",
                      ).offset().top,
                    },
                    500,
                  );
            ...
            $('.js-product-thumbnails-prev').on('click', function () {
              ...
              $('.js-product-thumbnails-next').attr(
                'data-current-group',
                currentGroup,
              );
              $('.js-product-thumnail-slider').addClass('d-none');
              $(
                ".js-product-thumnail-slider[data-group='" +
                  currentGroup +
                  "']",
              ).removeClass('d-none');
              return false;
            ...
            $('.js-product-thumbnails-next').on('click', function () {
              ...
              $(this).attr('data-current-group', currentGroup);
              $('.js-product-thumbnails-prev').attr(
                'data-current-group',
                currentGroup,
              );
              $('.js-product-thumnail-slider').addClass('d-none');
          ...
          productStickyAddToCart() {
            if ($('.js-product-action').length > 0) {
              $(window).scroll(function () {
                ...
                if (
                  scrollTop >
                  $('.js-product-action').offset().top +
                    $('.js-product-action').outerHeight()
                ) {
          ...
          quantity() {
            $('.js-quantity-down').on('click', function () {
              var q_val_up = parseInt(
                $(this).parent().find('.js-quantity-field').val(),
              );
              if (isNaN(q_val_up)) {
                q_val_up = 0;
              }
          ...
          tabs() {
            ...
            $('.js-tab-link').on('click', function () {
              ...
              $(this)
                ...
                .removeClass('tab-content__show');
              var that = $(this)
                .parent()
                .parent()
                .parent()
                .find(
                  ".js-tab-content[data-id='" + $(this).attr('data-id') + "']",
                );
          ...
          accordion() {
            $('.js-accordion-title').on('click', function () {
              ...
              $(this)
                ...
                .parent()
                .find(
                  '.js-accordion:not(.current).active .js-accordion-content',
                )
                .slideToggle(500);
              $(this)
                .parent()
                .parent()
                .find('.js-accordion:not(.current).active')
                .removeClass('active');
